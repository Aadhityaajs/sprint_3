...
export default function SummaryCards({ summary }) {
  return (
    <div className="flex gap-4 w-2/5 h-[100px] min-w-[480px]">
      ...
      <div className="bg-white p-5 rounded-xl flex-1 flex items-center justify-between shadow-sm">
        ...
        <div className="text-2xl text-gray-500 text-center font-semibold">Active</div>
      </div>
      <div className="bg-white p-5 rounded-xl flex-1 flex items-center justify-between shadow-sm">
        <div className="font-extrabold text-[42px] leading-none text-center">{summary.resolved}</div>
        <div className="text-2xl text-gray-500 text-center font-semibold">Resolved</div>
      </div>
    </div>
  );
}
