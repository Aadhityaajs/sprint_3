export const CONSTANTS = {
  ...
  // Property
  MIN_PROPERTY_PRICE: 100,
  MIN_PROPERTY_NAME_LENGTH: 5,
  MIN_PROPERTY_DESC_LENGTH: 20,
  CLEANING_FEE: 2000,
  ...
  // API
  API_BASE_URL: import.meta.env.VITE_API_URL || 'http://localhost:8081',
};
...
export const INDIAN_STATE_DISTRICTS = {
  "Andhra Pradesh": [
    ...
    "Krishna", "Kurnool", "Nandyal", "Nellore", "Palnadu", "Prakasam",
    "Sri Satyasai", "Srikakulam", "Tirupati", "Visakhapatnam",
    "Vizianagaram", "West Godavari", "YSR Kadapa"
  ],

  "Arunachal Pradesh": [
    "Tawang", "West Kameng", "East Kameng", "Pakke Kessang", "Papum Pare",
    "Kra Daadi", "Kurung Kumey", "Lower Subansiri", "Upper Subansiri",
    "West Siang", "Shi Yomi", "Upper Siang", "East Siang",
  ...
  "Chhattisgarh": [
    ...
    "Jashpur", "Kanker", "Kawardha", "Kondagaon", "Korba", "Koriya",
  ...
  "Nagaland": [
    ...
    "Mokokchung", "Mon", "Noklak", "Peren", "Phek",
  ...
  "Punjab": [
    ...
    "Nawanshahr", "Pathankot", "Patiala", "Rupnagar",
  ...
  "Telangana": [
    ...
    "Vikarabad", "Wanaparthy", "Warangal", "Yadadri"
  ],
  ...
  "Uttar Pradesh": [
    ...
    "Kasganj", "Kaushambi", "Kheri", "Kushinagar",
    "Lalitpur", "Lucknow", "Maharajganj", "Mahoba",
